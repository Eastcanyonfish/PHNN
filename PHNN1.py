...
class PHNN_Model:
    ...
    def define_model(self, input_shape):
        ...
        merged = Concatenate()([modelx.output, modely.output])
        z = Dense(128)(merged)
        z = Dropout(0.2)(z)
        z = Dense(16)(z)
        z = Dense(1)(z)
        ...
        self.model = Model(inputs=[modelx.input, modely.input], outputs=z)
    ...
    def train_model(self, train_data1, train_data2, train_labels, val_data1, val_data2, val_labels, batch_sizes=[16, 25, 32], epochs=300):
        ...
        for batch_size in batch_sizes:
            ...
            bm = ModelCheckpoint(
                f'best_model_batch_{batch_size}.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
            ...
            self.model.load_weights(f'best_model_batch_{batch_size}.h5')
        ...
        if best_model is not None:
            best_model.save(f"best_model_batch_{best_batch_size}.h5")
